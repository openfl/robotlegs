...
class StarlingInitializer extends BaseInitializer {
	...
	override public function addLayer(ViewClass:Class<Dynamic>, index:Int, total:Int, id:String):Void {
		...
		var starling:Starling = new Starling(cast ViewClass, contextView.view.stage, viewRectangle, stage3DRenderContext.stage3D, Context3DRenderMode.AUTO,
			profile #if !starling_1_x, true #end
		);
		#if !starling_1_x

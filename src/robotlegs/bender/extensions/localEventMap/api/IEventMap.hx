...
interface IEventMap
{
	 ...
	 */
	function mapListener(dispatcher:IEventDispatcher, type:String, listener:Function, eventClass:Class = null, useCapture:Bool = false, priority:Int = 0, useWeakReference:Bool = true):Void;
	 ...
	 * @param useCapture
	 */
	function unmapListener(dispatcher:IEventDispatcher, type:String, listener:Function, eventClass:Class = null, useCapture:Bool = false):Void;
